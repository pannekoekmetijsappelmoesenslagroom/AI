...
class MainApp(tk.Frame):
    ...
    def pause(self):
        self.root.after(int(self.delay.get()) * 10) # pause in msec
    ...
    def make_control_panel(self):
        # note that self.alg is an instance variable, and lf1 is a local variable
        # note that make_control_panel is an instance function an start_search is a local function
